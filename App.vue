<template>
  <div id="app">
    ...
    <h1>KeyValues</h1>
    <button v-on:click="loadHeader">HeaderDict</button> 
    <hr>
    <ul>   
      <select id ="Header" size="1" onchange="j();" >
      </select>
    </ul>
    <input type="text" id="buttonChannelList"/>
  </div>
</template>
<script>
    ...
    async loadHeader(){
      ...
      try{
        ...
        function j(){
          ...
          var text=item.opt[item.selectIndex].text;
          document.getElementById("buttonChannelList").value=text
        }
